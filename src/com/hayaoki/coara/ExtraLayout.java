...
public class ExtraLayout {
  ...
  private static final float BASE_DISPLAY_WIDTH = 1536;
  private static final float BASE_DISPLAY_HEIGHT = 2048;
  ...
  public static void setBaseImageView(Activity act,ImageView imageView,Bitmap image){
    Rect imageSize = new Rect(0, 0, (int)(image.getWidth() * getResizeRatio(act)), (int)(image.getHeight() * getResizeRatio(act)));
    imageView.getLayoutParams().width = imageSize.width();
    imageView.getLayoutParams().height = imageSize.height();
